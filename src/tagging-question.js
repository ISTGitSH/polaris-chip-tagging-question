  ...
  static get styles() {
    return css`
      ...
      #question {
        ...
        box-sizing: border-box;
        margin-bottom: var(--dd-spacing-8);
      }
      ...
      #droppedTags {
        box-sizing: border-box;
        padding: 24px 12px;
        border: solid 2px var(--ddd-theme-default-original87Pink);
      ...
      #image {
        max-width: 25%;
        height: auto;
        border: solid 3px var(--ddd-theme-default-original87Pink);
        border-radius: var(--ddd-radius-sm);
        margin: 0 auto;
        margin-top: 50px;
        margin-bottom: 50px;
      ...
      .chip {
        ...
        border-radius: var(--ddd-spacing-sm);
        box-sizing: border-box;
  ...
  connectedCallback() {
    ...
    fetch('src/tags-data.json')
      ...
      resetTags() {
        ...
        for (const tag of drppedTagsChips) {
      ...
      render() {
        return html`
          <confetti-container id="confetti">
              ...
              <div id="droppedTags" @click=${this.dropClicked} @dragover=${this.handleDragOver} @drop=${this.handleDrop}>
